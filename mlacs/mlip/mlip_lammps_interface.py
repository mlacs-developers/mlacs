...
class LammpsMlipInterface:
    ...
    reference_potential: :class:`dict`
        Reference potential to add to the MLIP. If None, the MLIP will fit the difference between the
...
#========================================================================================================================#
    def _write_lammps_input(self):
        ...
        input_string += "fix              mliap all ave/time 1 1 1 c_mliap[*] file descriptor.out mode vector format %15.5f  \n"# format %.15f\n" 
...
#========================================================================================================================#
    def load_mlip(self, dielectric=None):
        ...
        if self.style == "snap":
            ...
            style = "so3"
        pair_style_mliap = f" mliap  model {self.model} {cwd}/MLIP.mliap.model  descriptor {style} {cwd}/MLIP.mliap.descriptor"
